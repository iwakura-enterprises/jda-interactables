 ...
 */
public class InteractiveRowedMessage extends MessageInteractable {

    protected static final String randomFillerValue = UUID.randomUUID().toString();

    protected final @Getter List<ActionRow> actionRows = new ArrayList<>(Message.MAX_COMPONENT_COUNT);

    protected final @Getter Map<Interaction, Consumer<GroupedInteractionEvent>> interactions = new LinkedHashMap<>();
    protected final @Getter Map<String, Consumer<StringSelectInteractionEvent>> stringSelectInteractionEventConsumerMap = new LinkedHashMap<>();
    protected final @Getter Map<String, Consumer<EntitySelectInteractionEvent>> entitySelectInteractionEventConsumerMap = new LinkedHashMap<>();

    // Other
    protected @Getter @Setter MessageEditBuilder messageEditBuilder;

    protected InteractiveRowedMessage() {
    ...
    protected ActionRow getActionRowByIndex(int index) {
    ...
    protected RestAction<Message> sendEx(MessageChannelUnion messageChannelUnion, InteractionHook interactionHook, boolean ephemeral, boolean editOriginal, Message messageToEdit, Message messageToReplyTo) {
    ...
    /**
     * Builder for {@link InteractiveRowedMessage}
     */
    public static class Builder {

        protected final InteractiveRowedMessage interactiveRowedMessage = new InteractiveRowedMessage();
